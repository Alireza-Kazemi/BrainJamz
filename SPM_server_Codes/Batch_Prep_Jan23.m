...
matlabbatch{3}.spm.spatial.coreg.estwrite.roptions.mask = 1;
...
matlabbatch{4}.spm.spatial.preproc.tissue(1).tpm = {'/home/kazemi/Documents/MATLAB/spm12/tpm/TPM.nii,1'}; %infant-2yr-seg-gm.nii,1'}; %
matlabbatch{4}.spm.spatial.preproc.tissue(1).ngaus = 1;
matlabbatch{4}.spm.spatial.preproc.tissue(1).native = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(1).warped = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(2).tpm = {'/home/kazemi/Documents/MATLAB/spm12/tpm/TPM.nii,2'};%infant-2yr-seg-wm.nii,1'}; %
matlabbatch{4}.spm.spatial.preproc.tissue(2).ngaus = 1;
matlabbatch{4}.spm.spatial.preproc.tissue(2).native = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(2).warped = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(3).tpm = {'/home/kazemi/Documents/MATLAB/spm12/tpm/TPM.nii,3'}; %infant-2yr-seg-csf.nii,1'}; %
