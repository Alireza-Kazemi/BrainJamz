%-----------------------------------------------------------------------
% Job saved on 28-Jan-2023 07:11:50 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{4}.spm.spatial.preproc.tissue(1).tpm = {'/home/kazemi/Documents/MATLAB/spm12/tpm/infant-2yr-seg-gm.nii,1'};
matlabbatch{4}.spm.spatial.preproc.tissue(1).ngaus = 1;
matlabbatch{4}.spm.spatial.preproc.tissue(1).native = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(1).warped = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(2).tpm = {'/home/kazemi/Documents/MATLAB/spm12/tpm/infant-2yr-seg-wm.nii,1'};
matlabbatch{4}.spm.spatial.preproc.tissue(2).ngaus = 1;
matlabbatch{4}.spm.spatial.preproc.tissue(2).native = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(2).warped = [0 0];
matlabbatch{4}.spm.spatial.preproc.tissue(3).tpm = {'/home/kazemi/Documents/MATLAB/spm12/tpm/infant-2yr-seg-csf.nii,1'};
...
matlabbatch{6}.spm.spatial.coreg.estwrite.ref(1) = cfg_dep('Realign: Estimate & Reslice: Mean Image', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','rmean'));
matlabbatch{6}.spm.spatial.coreg.estwrite.source = {'/media/data/SIPAlireza/Jamz/PreprocessJan23/076/Highres_raw/s076-0002-00001-000256-01.img,1'};
...
matlabbatch{6}.spm.spatial.coreg.estwrite.roptions.mask = 1;
