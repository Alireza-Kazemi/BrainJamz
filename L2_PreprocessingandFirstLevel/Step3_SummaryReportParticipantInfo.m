% Sort out Tracking and reporting Files
...
% Target Reverse
Replication_IDs = string([76, 93, 95, 97, 98, 123, 124, 132, 133, 134, 141, 151, 153, 154, 156, 157, 158, 165, 177, 190, 195, 220, 221, 223, 226, 228, 230, 232, 234, 235]);
% Non-Target Reverse
Extension_IDs = string([155, 166, 169, 192, 199, 206, 208, 209, 210, 216,218, 219, 233, 239, 240, 242]); 
...
writetable(Info.TrackTable,'TrackTable.csv');